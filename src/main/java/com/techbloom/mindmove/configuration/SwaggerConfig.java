package com.techbloom.mindmove.configuration;
...
public class SwaggerConfig {
	...
	@Bean
    OpenAPI springMindMoveOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Projeto MindMove")
                .description("Projeto MindMove - Techbloom")
                .version("v0.0.1")
                .license(new License()
                    .name("Techbloom - Grupo E")
                    .url("https://github.com/TechBloom-GrupoE"))
                .contact(new Contact()
                    .name("Techbloom")
                    .url("https://github.com/TechBloom-GrupoE")
